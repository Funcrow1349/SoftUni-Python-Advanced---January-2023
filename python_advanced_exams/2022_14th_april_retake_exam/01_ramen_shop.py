...
#   •	Each time the value of the ramen is equal to the value of the customer, remove them both and continue with the
#       next bowl of ramen and the next customer.
#   •	Each time the value of the ramen is bigger than the value of the customer, decrease the value of that ramen with
#       the value of that customer and remove the customer. Then try to match the same bowl of ramen
...
#       o	Print all the left ramen bowls (if any) separated by comma and space in the format:
