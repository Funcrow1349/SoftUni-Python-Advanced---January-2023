...
#   Kamenitza	        70
#
#   Alex will try to conquer as many peaks as he can in seven days. If he manages to climb all the peaks, the journey
#   ends and the output is printed on the Console.
...
#       o	If he didn't manage to climb all the peaks: "Alex failed! He has to organize his journey better next time
#           -> @PIRINWINS"
...
for i in range(7):
    while daily_portions and stamina and mountain_peaks:

        daily_resources = daily_portions.pop() + stamina.popleft()
        if daily_resources >= mountain_peaks[0][1]:
            conquered_peaks.append(mountain_peaks[0][0])
